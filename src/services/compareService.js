...
const DEFAULT_USER_ID = "07ef7eff-96af-412c-9b2e-aeaa64d47a7d";

// const DEFAULT_USER_ID = "c35e9468-0951-4698-8ca5-61bdf8bd267e";
...
//비교기업 삭제
export async function deleteCompareCorp(corpId){
...
// 나의 기업 태그에서 삭제 시에 
export async function deleteMyCompareCorp(corpId){
